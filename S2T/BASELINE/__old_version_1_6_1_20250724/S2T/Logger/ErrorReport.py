...
import ipccli
import users.THR.PythonScripts.thr.S2T.ConfigsLoader as pe
...
elif  SELECTED_PRODUCT == 'CWF': DRGDUMP_ENABLED = True
...
def run(visual ='', Testnumber='', TestName='', chkmem = 0, debug_mca = 0, dr_dump = False, folder=None, WW = 'WW', Bucket = 'UNCORE', product = 'GNR', QDF = '', logger =None):
	"""
