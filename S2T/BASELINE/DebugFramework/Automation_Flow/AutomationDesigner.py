...
class AutomationFlowDesigner:
    ...
    def setup_styles(self):
        ...
        self.node_colors = {
            ...
            'CharacterizationFlowInstance': '#E8E8E8', # Light gray (idle state)
            'DataCollectionFlowInstance': '#E8E8E8',   # Light gray (idle state)
            'AnalysisFlowInstance': '#E8E8E8',        # Light gray (idle state)
        ...
        self.node_text_colors = {
            ...
            'CharacterizationFlowInstance': 'black',
            'DataCollectionFlowInstance': 'black',
            'AnalysisFlowInstance': 'black',
            'StartNode': 'black',
            'EndNode': 'black'
        }
