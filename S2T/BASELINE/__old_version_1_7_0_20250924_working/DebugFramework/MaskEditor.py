...
class SystemMaskEditor:
    ...
    def create_interface(self, root, core_hex, cha_hex, title, cdie, callback) -> None:
    ...
    def on_save(self, compute, core, cha) -> None:
        if compute == 0:
    ...
    def start(self, root):# -> dict[str, Any]:
        # Create main application window
...
def Masking(root, compute0_core_hex, compute0_cha_hex, compute1_core_hex, compute1_cha_hex, compute2_core_hex, compute2_cha_hex, product, callback):# -> dict[str, Any]:
