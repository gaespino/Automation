...
import users.gaespino.DebugFramework.SerialConnection as ser
import users.gaespino.DebugFramework.GNRMaskEditor as gme
import users.gaespino.DebugFramework.FileHandler as fh
import users.gaespino.DebugFramework.UI.ControlPanel as fcp
...
try:
	import users.gaespino.DebugFramework.Storage_Handler.DBHandler as db
	importlib.reload(db)
	...
	def upload_data(self):
		...
		if DATABASE_HANDLER_READY:
			try:
				...
				logger(f' Failed updloading data to DantaDB -- Excpetion {e}',2)
