...
class configurations:
	...
	def init_framework_vars(self):
		...
		ate_masks = 	{
							'CWFAP':{1:'FirstPass', 2:'SecondPass', 3:'RowPass1',4:'RowPass2'},
		...
		ate_config = 	{	
							'main':{
									...
									'l6':('\t> 4. Full Chip')},
							'CWFAP':{
									'l1':('\t> 1. FirstPass: All CDIEs - Columns [1, 3, 5, 7, 8]'),
									'l2':('\t> 2. SecondPass: All CDIEs - Columns [1, 2, 4, 6, 8]'),
									'l3':('\t> 3. RowPass1: CDIE0 - Rows [5,6], CDIE1 - Rows [6,7], CDIE2 - Rows [5,7]:'),
									'l4':('\t> 4. RowPass2: CDIE0 - Rows [5,7], CDIE1 - Rows [5,6], CDIE2 - Rows [6,7]:'),
									'maxrng' : 5},
							'CWFSP':{
		...
		dis2cpm_menu = 	{	
							'main':{
									...
									'l5':('\t> 6. Disable (0x5): Core1 and Core2'),
									'maxrng': 7},
							}
