...
#from ...DebugFramework.PPV.Decoder import decoder as mcparse
...
class ppv_report():
	def __init__(self, name, week, label, source_file, report, data_core = None, data_cha = None, reduced = False, mcdetail = True, overview = False, decode = False, mode='Bucketer', product = 'GNR'):
		...
		self.name = name
		self.product = product #name.upper() ## Setting it the same as the name, can be changed later
		self.week = week
		self.label = label
		self.output = report
