...
def test():
	...
	data = fpa.parse_zip_files(zip_file_path=zip_file_path, content=content_type, pass_array = pass_array, fail_array = fail_array, skip_array = skip_array , exclusion_string='pysv', casesens=False)
