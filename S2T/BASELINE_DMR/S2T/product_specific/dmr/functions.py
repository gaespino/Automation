...
class functions:
	...
	def core_apic_id(phys_module, cbb_index, compute_index, sv, id0, id1):
		...
		id0 = cores[0].ml3_cr_pic_extended_local_apic_id
		if morethan_1_cpm: id1 =  cores[-1].ml3_cr_pic_extended_local_apic_id
...
==========================================================================================================
    ____  __  _______     _______  _____________________  ___   ___     _________________________________
