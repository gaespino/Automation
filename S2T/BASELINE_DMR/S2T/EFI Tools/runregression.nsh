...
echo     runregression.nsh <OBJ DIR> <match string_1> <match string_n>: Runs all OBJS that contain the <string>
...
echo "%1 input %" --> Seeds directory
echo "%2, 3, 4,... input %" --> does a regular expression on all OBJs can use multiple or just one
...
echo **************************************
echo ***** runregression version 1.13 *****
...
# Accepts Multiple Seed Filter options
