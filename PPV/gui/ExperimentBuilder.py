...
class ExperimentBuilderGUI:
    ...
    def get_default_template(self):
        ...
        return {
            "field_configs": {
                ...
                "Core Disable List": {"section": "Test Configuration", "type": "str", "default": "", "description": "Comma-separated physical core numbers to disable (IA only, e.g. '62, 70')", "required": False},
                "Slice Disable List": {"section": "Test Configuration", "type": "str", "default": "", "description": "Comma-separated physical core numbers to disable (core and LLC, e.g. '60, 72')", "required": False},
                "Temperature SP": {"section": "Test Configuration", "type": "float", "default": None, "description": "Temperature setpoint (°C) for Intec temperature control", "required": False},
    ...
    def create_advanced_section(self, parent, widgets, start_row):
        ...
        fields = [
            ...
            ("Core Disable List", "str", None, "Comma-separated physical core numbers to disable IA only (e.g. '62, 70')", False),
            ("Slice Disable List", "str", None, "Comma-separated physical core numbers to disable core and LLC (e.g. '60, 72')", False),
            ("Temperature SP", "float", None, "Temperature setpoint (°C) for Intec temperature control", False),
