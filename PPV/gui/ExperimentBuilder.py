...
class ExperimentBuilderGUI:
    ...
    def create_content_tab(self):
        ...
        tk.Label(scrollable_frame, text="Dragon Configuration",
                font=('Segoe UI', 11, 'bold'), bg='white').grid(
                    row=8, column=0, columnspan=3, sticky='w', padx=10, pady=(20, 10))
        
        self.create_field(scrollable_frame, "Dragon Content Path", "str", 9, browse=True,
                         description="Path to Dragon content")
        self.create_field(scrollable_frame, "Dragon Pre Command", "str", 10,
                         description="Command to run before Dragon")
        self.create_field(scrollable_frame, "Dragon Post Command", "str", 11,
                         description="Command to run after Dragon")
        self.create_field(scrollable_frame, "ULX Path", "str", 12, browse=True,
                         description="Path to ULX files")
        self.create_field(scrollable_frame, "ULX CPU", "str", 13,
                         description="CPU type for ULX")
    ...
    def create_advanced_tab(self):
        ...
        self.create_field(scrollable_frame, "Boot Breakpoint", "str", 1,
                         description="Boot breakpoint address")
        self.create_field(scrollable_frame, "Check Core", "int", 2,
                         description="Core number to check")
        self.create_field(scrollable_frame, "Stop on Fail", "bool", 3,
                         description="Stop execution on failure")
        self.create_field(scrollable_frame, "Post Process", "str", 4,
