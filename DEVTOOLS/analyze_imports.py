...
# Resolved relative to this file: <WORKSPACE_ROOT>/DEVTOOLS/analyze_imports.py
_DEVTOOLS_DIR = Path(__file__).resolve().parent
BASELINE_PATH = _DEVTOOLS_DIR.parent / "S2T" / "BASELINE"
...
def main():
    ...
    # Save to file
    output_file = _DEVTOOLS_DIR / "BASELINE_IMPORTS_DETAILED.md"
